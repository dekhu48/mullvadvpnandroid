...
@Composable
fun mullvadWhiteTextFieldColors(): TextFieldColors = TextFieldDefaults.colors(
...
@Composable
fun mullvadDarkTextFieldColors(): TextFieldColors = TextFieldDefaults.colors(
    ...
    unfocusedContainerColor = MaterialTheme.colorScheme.onPrimary.copy(alpha = Alpha20)
