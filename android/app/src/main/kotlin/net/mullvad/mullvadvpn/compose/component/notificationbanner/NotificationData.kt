...
fun InAppNotification.toNotificationData(
    ...
    is InAppNotification.NewDevice -> NotificationData(
    ...
    is InAppNotification.AccountExpiry -> NotificationData(
    ...
    is InAppNotification.UpdateAvailable -> NotificationData(
