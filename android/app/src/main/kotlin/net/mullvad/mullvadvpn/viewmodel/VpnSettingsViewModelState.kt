...
data class VpnSettingsViewModelState(
    ...
    fun toUiState(): VpnSettingsUiState = VpnSettingsUiState(
        mtuValue,
    ...
    companion object {
        ...
        fun default() = VpnSettingsViewModelState(
...
private fun VpnSettingsDialogState?.toUi(
    ...
    VpnSettingsDialogState.CustomPortDialog -> VpnSettingsDialog.CustomPort(
        vpnSettingsViewModelState.availablePortRanges,
    )

    is VpnSettingsDialogState.DnsDialog -> VpnSettingsDialog.Dns(stagedDns)
    VpnSettingsDialogState.LocalNetworkSharingInfoDialog -> VpnSettingsDialog.LocalNetworkSharingInfo
    ...
    VpnSettingsDialogState.QuantumResistanceInfoDialog -> VpnSettingsDialog.QuantumResistanceInfo

    VpnSettingsDialogState.WireguardPortInfoDialog -> VpnSettingsDialog.WireguardPortInfo(
        vpnSettingsViewModelState.availablePortRanges,
    )
