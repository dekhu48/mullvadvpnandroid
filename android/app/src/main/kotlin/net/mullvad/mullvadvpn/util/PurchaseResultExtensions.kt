...
fun PurchaseResult.toPaymentDialogData(): PaymentDialogData? = when (this) {
    // Idle states
    ...
    PurchaseResult.VerificationStarted -> PaymentDialogData(
    ...
    // Success state
    PurchaseResult.Completed.Success -> PaymentDialogData(
    ...
    // Error states
    is PurchaseResult.Error.TransactionIdError -> PaymentDialogData(
