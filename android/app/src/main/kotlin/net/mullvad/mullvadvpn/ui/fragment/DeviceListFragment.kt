...
class DeviceListFragment : Fragment() {
            ...
            findViewById<ComposeView>(R.id.compose_view).setContent {
                AppTheme {
                    ...
                    DeviceListScreen(
                        ...
                        onConfirmDeviceRemovalDialog = deviceListViewModel::confirmRemovalOfStagedDevice,
                    )
                }
            }
        }
    ...
    private fun CoroutineScope.launchUiSubscriptionsOnResume() = launch {
        deviceListViewModel.toastMessages.flowWithLifecycle(lifecycle, Lifecycle.State.RESUMED)
