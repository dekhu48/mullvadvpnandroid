...
fun ProductDetailsResult.toPaymentAvailability(
    ...
    BillingClient.BillingResponseCode.BILLING_UNAVAILABLE -> PaymentAvailability.Error.BillingUnavailable
    BillingClient.BillingResponseCode.SERVICE_UNAVAILABLE -> PaymentAvailability.Error.ServiceUnavailable
    BillingClient.BillingResponseCode.DEVELOPER_ERROR -> PaymentAvailability.Error.DeveloperError
    BillingClient.BillingResponseCode.FEATURE_NOT_SUPPORTED -> PaymentAvailability.Error.FeatureNotSupported
    BillingClient.BillingResponseCode.ITEM_UNAVAILABLE -> PaymentAvailability.Error.ItemUnavailable
    else -> PaymentAvailability.Error.Other(
